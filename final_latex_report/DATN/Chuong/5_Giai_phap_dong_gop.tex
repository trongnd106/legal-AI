...
Các đóng góp giải quyết các vấn đề cụ thể trong lĩnh vực pháp luật (trích dẫn chính xác, suy luận logic, hiệu lực tạm thời) mà GraphRAG gốc và RAG truyền thống không xử lý được. Framework được thiết kế để tái sử dụng trong các domain pháp lý khác bằng cách thay đổi parser, entity types, và rule validator mà không cần thiết kế lại toàn bộ kiến trúc. Chương~\ref{chapter:conclusion} tổng kết hạn chế và hướng phát triển.
